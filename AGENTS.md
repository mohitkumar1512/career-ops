...
| Asks to evaluate offer | `offer` (read `modes/oferta.md`) |
| Asks to compare offers | `offers` (read `modes/ofertas.md`) |
| Wants LinkedIn outreach | `contact` (read `modes/contacto.md`) |
